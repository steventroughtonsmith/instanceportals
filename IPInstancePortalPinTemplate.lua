...
function IPInstancePortalProviderPinMixin:OnClick(button)
  ...
  useTomTom = useTomTom and (TomTom ~= nil) or false
	...
	if Debug and Debug == true then print("button: "..button) end
	if Debug and Debug == true then print("self.hub: "..self.hub) end
            ...
            if dungeonEntranceInfo.journalInstanceID == journalInstanceID then -- found Dungeon with matching instanceID
              ...
              wp_name = dungeonEntranceInfo.name or "Waypoint"
							if Debug and Debug == true then
								print("childMapInfo.mapID: "..childMapInfo.mapID)
								print("dungeonEntranceInfo.name: "..dungeonEntranceInfo.name)
								print("dungeonEntranceInfo.position.x: "..dungeonEntranceInfo.position.x)
								print("dungeonEntranceInfo.position.y: "..dungeonEntranceInfo.position.y)
							end
						end
          end
				end
